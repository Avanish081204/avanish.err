...
const projects = [
  {
    ...
    color: "#EA4335",
    title: "Canteen Grab and Go",
    subtitle: "Campus Food Ordering System",
    org: "canteen-grab-go.vercel.app",
    desc: "A transactional full-stack order-handling application featuring algorithmic token allocation, reducing average user waiting times by 35%. Architected multi-role administrative frameworks managing live payment integrations, data tables, and dynamic tracking states for scalable performance.",
    tags: ["React.js", "Node.js", "Express.js", "MongoDB", "Live Demo"],
  ...
  },
  {
    ...
    color: "#1A73E8",
    title: "Rentify",
    subtitle: "Multi Category Rental Platform",
    org: "github.com › Avanish081204 › Rentify",
    desc: "An online rental marketplace enabling users to rent or list products with end-to-end booking management. Implemented core features including secure authentication, product listings, booking system, search/filters, wishlist, reviews, owner dashboard, admin panel, and Cloudinary image upload.",
    tags: ["React.js", "Node.js", "Express.js", "MongoDB", "JWT", "Cloudinary"],
    github: "https://github.com/Avanish081204/Rentify",
  },
  {
    Icon: Database,
    color: "#34A853",
